...
class TestOrchestrator:
    ...
    async def test_run_full_flow(self, orchestrator):
        ...
        mock_factory_obj.create_dynamic = AsyncMock(return_value=mock_agent)
    ...
    async def test_run_with_dependencies(self, orchestrator):
        ...
        mock_factory_obj = MagicMock()
        mock_factory_obj.create_dynamic = AsyncMock(side_effect=[mock_agent_res, mock_agent_writer])
...
class TestOrchestratorWeek2:
    ...
    async def test_run_subtask_retries_on_failure(self, orchestrator):
        ...
        mock_factory.create_dynamic = AsyncMock(return_value=mock_agent)
        ...
        with (
            ...
            assert mock_factory.create_dynamic.call_count == 3
    ...
    async def test_independent_subtasks_run_in_parallel(self, orchestrator):
        ...
        mock_factory = MagicMock()
        mock_factory.create_dynamic = AsyncMock(side_effect=[agent_a, agent_b])
